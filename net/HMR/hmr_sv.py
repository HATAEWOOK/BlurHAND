...
class HMR_SV(nn.Module):
    def __init__(self):
        ...
        self.mano = ManoLayer(side='right', mano_root="/mnt/workplace/blurHand/models/", use_pca=False)
        self.rgb2hm = RGB2HM()
    ...
    def forward(self, input, target=None):
        ...
        if self.training:
            ...
            keypt_tar = proj_func(target['j3d'], target['Ks'])
